...
public class TPurchaseOrdersDetail {
    ...
    /**
     * 订单详情状态(0:初始,1:缺货,2:完成,3:退货,4:部分退)
     */
    ...
    /**
     * 获取订单详情状态(0:初始,1:缺货,2:完成,3:退货,4:部分退)
     *
     * @return order_detail_status - 订单详情状态(0:初始,1:缺货,2:完成,3:退货,4:部分退)
     */
    ...
    /**
     * 设置订单详情状态(0:初始,1:缺货,2:完成,3:退货,4:部分退)
     *
     * @param orderDetailStatus 订单详情状态(0:初始,1:缺货,2:完成,3:退货,4:部分退)
     */
